...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{images/PCB Design Layout.png}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{images/Drill Chart.png}
    \caption{Enter Caption}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=1.0\linewidth]{images/Silk Screen.png}
    \caption{Enter Caption}
    \label{fig:enter-label}
\end{figure}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
