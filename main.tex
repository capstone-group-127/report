...
\begin{tabular}{|l|l|}
\hline
\textbf{Tooling Requirements} & \textbf{Filament Type} - PLA \\ \hline
\textbf{Tooling Requirements} & \textbf{Print Bed Surface} - Glass bed \\ \hline
\textbf{Tooling Requirements} & \textbf{Post-Processing Tools} - Sandpaper, Deburring tool \\ \hline
\textbf{Tooling Requirements} & \textbf{Assembly Tools} - Screwdriver for Assembly \\ \hline
