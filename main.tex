...
\par The problem, therefore, is to design a universal, low-cost data acquisition and logging system for drones that supports modular USB sensor integration, onboard data storage with integrity verification, and compliance with operational safety standards. The solution must not rely on wireless data transmission, must store data in a platform-agnostic format, and must be rugged enough for field deployment in moderate outdoor environments.
...
%\begin{itemize}[noitemsep]
  ...
  % \end{itemize}
    \begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/PCB Design Layout.png}
    \caption{PCB Layout}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Drill Chart.png}
    \caption{Drill Chart}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Silk Screen.png}
    \caption{Silk Screen}
    \label{fig:enter-label}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Right Side of PCB casing.png}
    \caption{Right Side View of PCB Casing}
    \label{fig:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Bottom side of PCB casing.png}
    \caption{Bottom Side of PCB Casing}
    \label{fig:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Front View of PCB Casing.png}
    \caption{Front View of PCB Casing}
    \label{fig:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Top viiew of the PCB casing open.png}
    \caption{Top Side View of the PCB Casing}
    \label{fig:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Top front view of PCB Casing Open.png}
    \caption{Top Front View of the PCB Casing}
    \label{fig:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Specifications of Casing.png}
    \caption{Materials, Tools, Cost Specifications for the PCB Casing}
    \label{Table:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/PCB CAD Drawing.png}
    \caption{PCB CAD Casing}
    \label{fig:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.8\linewidth]{images/Initial PCB Footprint layout.png}
    \caption{Initial PCB Footprint Layout}
    \label{fig:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{images/Parrot AR.Dron Casing.jpg}
    \caption{Parrot AR.Drone Casing}
    \label{fig:enter-label}
\end{figure}

\begin{figure}
    \centering
    \includegraphics[width=0.7\linewidth]{images/Parrot Anafi USA Casing.jpg}
    \caption{Parrot Anafi USA Casing}
    \label{fig:enter-label}
\end{figure}
