...
\begin{table}[htbp!]
	\centering
	\begin{tabular}{lllll}
		\multicolumn{3}{c}{Loading   Analysis}       &  &  \\
		\multicolumn{3}{c}{15V Devices}              &  &  \\
		Device No.     & Device Descriptor & Current &  &  \\
		LMR51430XDDCR  & Buck Converter    & 300 mA  &  &  \\
		\multicolumn{3}{c}{5V Devices}               &  &  \\
		AE11131-ND     & USB 2.0 Ports     & 100 mA  &  &  \\
		FT231XS-R      & USB to UART       & 8 mA    &  &  \\
		XC6210A332MR-G & LDO               & 100 mA  &  &  \\
		\multicolumn{3}{c}{3.3V Devices}             &  &  \\
		STM32F072CB    & Microcontroller   & 120 mA  &  &  \\
		CAT25160VI-GT3 & EEPROM            & 2 mA    &  &  \\
		TUSB2046I      & USB Hub           & 40 mA   &  & 
	\end{tabular}
\end{table}
