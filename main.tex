...
\quickfigure{images/microcontroller.png}{15cm}{The Microcontroller and Related Connections}
\quickfigure{images/usb-a.png}{15cm}{USB-A Ports Connected to USB Hub}
\quickfigure{images/usb-c.png}{15cm}{USB-C Port Connected to USB to UART IC}
\quickfigure{images/buck.png}{15cm}{Buck Converter Used to Regulate Battery to 5V}
\quickfigure{images/ldo.png}{15cm}{LDO Used to Regulate 5V down to 3.3V}
\quickfigure{images/spi.png}{15cm}{SPI Device and Related Connections}
\newpage
%\section*{References}
