...
\begin{enumerate}
    ...
    sudo ./VirtualHub
    \end{verbatim}
    \item Install Yoctopuce API Library from https://www.yoctopuce.com/EN/libraries.php
    \item Install pyserial
    \item Install digitemp for interfacing with the DS18B20 via UART temperature sensor.
